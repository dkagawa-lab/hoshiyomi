...
export const servicePlans: ServicePlan[] = [
  ...
  },
  {
    ...
    regulations: ["初回だけ480円で始められます", "月50回まで相談できます", "マイルド・はっきり厳しめを選べます", "出生プロフィールと星読みカルテを参照できます"],
  ...
  },
  {
    ...
    regulations: ["月200回まで相談できます", "共感を強めた寄り添い系と辛辣鑑定を含む、すべての鑑定士タイプを選べます", "育った星読みカルテをより深く参照します", "回答は濃いめ・長めで、判断基準まで踏み込みます"],
