    ...
    <main className="shell detail-shell">
      ...
      <section className="detail-section legal-doc">
        ...
        <article className="terms-block">
          <h2>4. 解約</h2>
          <p>
            解約は、アカウント画面またはお問い合わせから受け付けます。解約後も、既に支払い済みの利用期間中はプラン特典を利用できる場合があります。Stripeの管理画面を導入する場合は、解約導線をアカウント画面へ追加します。
          </p>
        </article>
        ...
        <article className="terms-block">
          <h2>6. 相談回数と追加枠</h2>
          <p>
            各プランの相談回数は、プラン画面に表示された回数に従います。追加100回パックは、月の相談回数を使い切った後も相談を続けるための追加枠です。追加枠の有効期限や翌月繰越の扱いは、本番公開前に最終決定して明記してください。
          </p>
        </article>
